...
public class RandomGeode extends RandomisedFeature {
    ...
    NbtCompound feature() {
        ...
        blocks.put("inner_layer_provider", PROVIDER.randomBlockProvider(random, "stone_like_blocks"));
        ...
        blocks.put("outer_layer_provider", PROVIDER.randomBlockProvider(random, "stone_like_blocks"));
